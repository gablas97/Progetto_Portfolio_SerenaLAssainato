...
return [
    ...
    | le composant de validation. Certaines de ces règles ont plusieurs versions
    | selon le type de données qu'elles valident. N'hésitez pas à
    |
    */
    ...
    'contains' => 'Le champ :attribute est privé d\'une valeur requise.',
    'current_password' => 'Le mot de passe est incorrect.',
    'date' => 'Le champ :attribute doit être une date valide.',
    'date_equals' => 'Le champ :attribute doit être une date égale à :date.',
    'date_format' => 'Le champ :attribute doit correspondre au format :format.',
    'decimal' => 'Le champ :attribute doit avoir :decimal chiffres décimaux.',
    'declined' => 'Le champ :attribute doit être rifiutato.',
    'declined_if' => 'Le champ :attribute doit être rifiutato lorsque :other est :value.',
    'different' => 'Le champ :attribute et :other doivent être divers.',
    ...
    'doesnt_contain' => 'Le champ :attribute ne doit contenir aucun des valeurs suivantes: :values.',
    'doesnt_end_with' => 'Le champ :attribute ne doit pas terminer avec l\'une des valeurs suivantes: :values.',
    'doesnt_start_with' => 'Le champ :attribute ne doit pas commencer avec l\'une des valeurs suivantes: :values.',
    'email' => 'Le champ :attribute doit être un indirizzo email valide.',
    'encoding' => 'Le champ :attribute doit être codifié en :encoding.',
    ...
    'hex_color' => 'Le champ :attribute doit être un couleur hexadécimale valide.',
    ...
    'mac_address' => 'Le champ :attribute doit être un indirizzo MAC valide.',
    'max' => [
        'array' => 'Le champ :attribute ne doit pas avoir plus de :max éléments.',
        'file' => 'Le champ :attribute ne doit pas être maggiore di :max kilobytes.',
        'numeric' => 'Le champ :attribute ne doit pas être maggiore di :max.',
        'string' => 'Le champ :attribute ne doit pas être maggiore di :max caractères.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur fournie pour :attribute est apparue dans un data leak. Choisir une valeur différente pour :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier des messages de validation personnalisés pour des attributs spécifiques en 
    | utilisant la convention "attribut.règle" pour nommer les lignes. Cela vous permet d'avoir des 
    | messages personnalisés pour des champs spécifiques selon la règle de validation qui échoue.
    |
    */
    ...
    | avec quelque chose de plus lisible comme "Adresse Email" au lieu de "email".
    | Cela aide simplement à rendre les messages plus expressifs.
    |
    */
