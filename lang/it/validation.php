...
return [
    ...
    | il componente di validazione. Alcuni di questi regole hanno più versioni
    | a seconda del tipo di dato che stanno validando. Sentiti libero
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore fornito per :attribute è apparso in un data leak. Scegliere un valore diverso per :attribute.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Linee di validazione personalizzate
    |--------------------------------------------------------------------------
    |
    | Qui puoi specificare messaggi di validazione personalizzati per attributi specifici utilizzando la
    | convenzione "attributo.regola" per nominare le righe. Questo ti permette di avere messaggi
    | personalizzati per campi specifici a seconda della regola di validazione che fallisce.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti linee di lingua sono utilizzate per scambiare il segnaposto dell'attributo
    | con qualcosa di più leggibile come "Indirizzo Email" invece di "email".
    | Questo aiuta semplicemente a rendere i messaggi più espressivi.
    |
    */
